...
impl ::protobuf::Message for NodeProto {
    ...
    fn default_instance() -> &'static NodeProto {
        static mut instance: ::protobuf::lazy::Lazy<NodeProto> = ::protobuf::lazy::Lazy::INIT;
        unsafe { instance.get(NodeProto::new) }
    }
}
...
impl ::protobuf::Message for LayerProto {
            ...
            descriptor.get(|| {
                ...
                fields.push(
                    ::protobuf::reflect::accessor::make_repeated_field_accessor::<
                        _,
                        ::protobuf::types::ProtobufTypeMessage<NodeProto>,
                    >(
                        "nodes",
    ...
    fn default_instance() -> &'static LayerProto {
        static mut instance: ::protobuf::lazy::Lazy<LayerProto> = ::protobuf::lazy::Lazy::INIT;
        unsafe { instance.get(LayerProto::new) }
    }
}
...
impl ::protobuf::Message for CoreProto {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if self.cutoff != 0 {
            my_size +=
                ::protobuf::rt::value_size(3, self.cutoff, ::protobuf::wire_format::WireTypeVarint);
        }
        ...
        if self.dim != 0 {
            my_size +=
                ::protobuf::rt::value_size(7, self.dim, ::protobuf::wire_format::WireTypeVarint);
        }
        if self.count != 0 {
            my_size +=
                ::protobuf::rt::value_size(8, self.count, ::protobuf::wire_format::WireTypeVarint);
        }
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(
                    ::protobuf::reflect::accessor::make_repeated_field_accessor::<
                        _,
                        ::protobuf::types::ProtobufTypeMessage<LayerProto>,
                    >(
                        "layers",
    ...
    fn default_instance() -> &'static CoreProto {
        static mut instance: ::protobuf::lazy::Lazy<CoreProto> = ::protobuf::lazy::Lazy::INIT;
        unsafe { instance.get(CoreProto::new) }
    }
}
