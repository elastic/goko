    ...
    ($base:ident, $simd_16_base:ident, $simd_8_base:ident, $sparse_base:ident, $dist_base:ident, $norm_base:ident) => {
        ...
        pub fn $dist_base(mut x: &[$base], mut y: &[$base]) -> f32 {
            ...
            let leftover = y
                .iter()
                .zip(x)
                .map(|(xi, yi)| (*xi as f32 - *yi as f32) * (*xi as f32 - *yi as f32))
...
make_l2_distance!(i8,i8x16,i8x8,l1_sparse_i8_f32,l1_dist_i8,l1_norm_i8);
make_l2_distance!(u8,u8x16,u8x8,l1_sparse_u8_f32,l1_dist_u8,l1_norm_u8);
make_l2_distance!(i16,i16x16,i16x8,l1_sparse_i16_f32,l1_dist_i16,l1_norm_i16);
make_l2_distance!(u16,u16x16,u16x8,l1_sparse_u16_f32,l1_dist_u16,l1_norm_u16);
make_l2_distance!(i32,i32x16,i32x8,l1_sparse_i32_f32,l1_dist_i32,l1_norm_i32);
make_l2_distance!(u32,u32x16,u32x8,l1_sparse_u32_f32,l1_dist_u32,l1_norm_u32);
